const leadClaw = require('./skills/lead-claw');
const productClaw = require('./skills/product-claw');
const quoteClaw = require('./skills/quote-claw');
const contractClaw = require('./skills/contract-claw');
const installClaw = require('./skills/install-claw');
const supportClaw = require('./skills/support-claw');
