...
const salesClawRoutes = require('./src/routes/sales-claw');
const salesAutomationRoutes = require('./src/routes/sales-automation');
...
app.use('/api/sales', salesRoutes);
  ...
  app.use('/api/sales-claw', salesClawRoutes);
  app.use('/api/sales-auto', salesAutomationRoutes);
